# Learning Python: 10 apps
Python online course based on practical exercises that I'll be posting on this repo.
...
### 15. Intro to Databases
  > sqlite3 (SQLLite) and psycopg2 (PostgreSQL) libraries

### 16. App 5: Desktop Database Application
